...
insert into menu values (5, '밥류', '기본김밥', 3000);
insert into menu values (6, '밥류', '치즈김밥', 3500);
insert into menu values (7, '밥류', '스팸마요 컵밥', 4000);
insert into menu values (8, '밥류', '참치마요 컵밥', 4000);

insert into menu values (9, '튀김류', '만두(3개)', 3000);
